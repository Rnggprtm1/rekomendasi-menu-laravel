...
<span id="step-count-data" data-count="{{ count($recipe->steps ?? []) }}" style="display:none"></span>
<script>
    ...
    let stepCount = parseInt(document.getElementById('step-count-data').dataset.count, 10);
    function addStep() {
