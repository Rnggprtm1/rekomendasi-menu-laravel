...
<div class="card" style="padding:32px">
    <h2 style="font-size:1em;font-weight:700;color:#f1f5f9;margin-bottom:28px"><i class="fas fa-plus" style="color:#f39c12"></i> Tambah Resep Baru</h2>
        ...
        <div class="form-row">
            <div class="form-group">
                ...
                <input type="text" name="name" class="form-control"
                       ...
                       placeholder="cth: Ayam Geprek Pedas" required>
            </div>
            <div class="form-group">
                ...
                <div style="border: 2px dashed #334155; border-radius: 10px; padding: 16px; text-align:center; cursor:pointer; transition: border-color 0.2s;" onclick="document.getElementById('imageUpload').click()" id="dropZone">
                    ...
                    <p style="color:#94a3b8; font-size:0.82em; margin:0;"><i class="fas fa-cloud-upload-alt" style="margin-right:6px;"></i>Klik untuk pilih gambar</p>
                    <p style="color:#475569; font-size:0.75em; margin:4px 0 0;">Format: JPG, JPEG, PNG, WEBP (Maks. 2MB)</p>
                </div>
        ...
        <div class="form-row-3">
            <div class="form-group">
                ...
                <input type="number" name="time" class="form-control"
                       value="{{ old('time', 15) }}" min="1" required>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input type="number" name="portion" class="form-control"
                       value="{{ old('portion', 1) }}" min="1" required>
            </div>
        </div>

        <div class="form-group">
            <label>Bahan-bahan * <span style="font-weight:400;color:#475569">(pisahkan dengan koma)</span></label>
            <input type="text" name="ingredients" class="form-control"
                   value="{{ old('ingredients', $prefill['bahan'] ?? '') }}"
                   placeholder="telur, garam, minyak, bawang putih" required>
        </div>

        <div class="form-group">
            <label>Langkah Memasak *</label>
            <p style="font-size:0.78em;color:#475569;margin-bottom:12px">Masukkan menit ke berapa setiap instruksi dijalankan (diurutkan dari terbesar ke terkecil)</p>
            <div class="steps-container" id="stepsContainer">
                <div class="step-row">
                    <input type="number" name="steps[0][minute]" placeholder="Menit" min="0" class="form-control" style="padding:8px">
                    <textarea name="steps[0][text]" rows="2" placeholder="Instruksi langkah ini..." class="form-control" style="padding:8px"></textarea>
...
<script>
    ...
    function addStep() {
        ...
        div.innerHTML = `
            ...
            <textarea name="steps[${stepCount}][text]" rows="2" placeholder="Instruksi langkah ini..." class="form-control" style="padding:8px"></textarea>
            <button type="button" class="btn btn-danger btn-sm" onclick="removeStep(this)"><i class="fas fa-times"></i></button>
        `;
        c.appendChild(div);
        stepCount++;
